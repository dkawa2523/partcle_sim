...
def initial_collision_diagnostics() -> Dict[str, object]:
    counters: Mapping[str, object] = {
        ...
        'source_surface_release_grace_enabled': 0,
        'source_surface_release_grace_time_s': 0.0,
        'source_surface_release_grace_clearance_m': 0.0,
        'source_surface_release_grace_min_outward_normal_speed_mps': 0.0,
        'source_surface_release_skip_count': 0,
